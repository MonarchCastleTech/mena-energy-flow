...
def main()->None:
 ...
 if coverage==0:
  out["meta"]["mode"]="unavailable"
  out["warning"].update(score=None,raw_score=None,concurrence_bonus=None,status="UNAVAILABLE",headline="No source-backed energy-flow warning score is available.")
  out["history"]=old.get("history",[])[-60:]
